...
fn construct_start_board() {
    ...
    assert_eq!(Some(Piece::new(Rook, Black)), start_board.squares[0]);
    assert_eq!(Some(Piece::new(Knight, Black)), start_board.squares[1]);
    assert_eq!(Some(Piece::new(Bishop, Black)), start_board.squares[2]);
    assert_eq!(Some(Piece::new(Quieen, Black)), start_board.squares[3]);
    assert_eq!(Some(Piece::new(King, Black)), start_board.squares[4]);
    assert_eq!(Some(Piece::new(Bishop, Black)), start_board.squares[5]);
    assert_eq!(Some(Piece::new(Knight, Black)), start_board.squares[6]);
    assert_eq!(Some(Piece::new(Rook, Black)), start_board.squares[7]);
    for i in 8..15 {
        assert_eq!(Some(Piece::new(Pawn, Black)), start_board.squares[i]);
    }
    for i in 16..47 {
        assert_eq!(None, start_board.squares[i]);
    }
    for i in 48..55 {
        assert_eq!(Some(Piece::new(Pawn, White)), start_board.squares[i]);
    }
    assert_eq!(Some(Piece::new(Rook, White)), start_board.squares[56]);
    assert_eq!(Some(Piece::new(Knight, White)), start_board.squares[57]);
    assert_eq!(Some(Piece::new(Bishop, White)), start_board.squares[58]);
    assert_eq!(Some(Piece::new(Quieen, White)), start_board.squares[59]);
    assert_eq!(Some(Piece::new(King, White)), start_board.squares[60]);
    assert_eq!(Some(Piece::new(Bishop, White)), start_board.squares[61]);
    assert_eq!(Some(Piece::new(Knight, White)), start_board.squares[62]);
    assert_eq!(Some(Piece::new(Rook, White)), start_board.squares[63]);
